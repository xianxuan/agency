...
<div class="content">
    <div id="jquery-accordion-menu" class="jquery-accordion-menu red">
       ...
       <a href="<%=basePath%>hyAction!logout.action"><i class="fa fa-home"></i>注销</a>
        </div>
        <!--<ul id="demo-list">
            <li class="active">
        ...
        <ul id="demo-list">
            <li class="active">
                <a href="<%=basePath%>houseAction!getNewHouses.action"><i class="fa fa-home"></i>最新发布</a>
                
            </li>
            <li class="active">
                <a href="<%=basePath%>houseAction.action"><i class="fa fa-home"></i>房屋管理</a>
                
            </li>
            <li class="active">
                <a href="<%=basePath%>houseAction!getGoodHouses.action"><i class="fa fa-home"></i>精品房屋</a>
                
            </li>
            <li class="active">
                <a href="<%=basePath%>hyAction!jumpEditInfor.action"><i class="fa fa-home"></i>信息管理</a>
