...
<body>
    <div class="big">
        ...
        <div class="right">
            ...
            <!--以上的不变-->
            <form id="form1" action="<%=basePath%>hyAction!register.action" method="post">
                <div class="name">
                    <label>姓名<input type="text" id ="Name" name="user.name" value =""/></label><label id="Name1" style="color:#ff0000; margin-left:0px"></label>
                </div>
                
                <div class="name">
                    <label>电话<input type="text" id ="Phone" name="user.phone" value =""/></label><label id="High1" style="color:#ff0000; margin-left:0px"></label>
                </div>
                <div class="name">
                    <label>邮箱<input type="text" id ="email" name="user.mail" value =""/></label><label id="High1" style="color:#ff0000; margin-left:0px"></label>
                </div>
                <div class="name">
                    <label>密码<input type="password" id ="Psw" name="user.psw" value =""/></label><label id="High1" style="color:#ff0000; margin-left:0px"></label>
                </div>
                <div class="name">
